...
*   **Quota allocation**
    ...
    | 50%    | Add liquidity     | After the mainnet launch | Determined by the market | None                                  | None               | uniswap pancakeswap            |
...
| -------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| Mark Landmarks | Cities in the Metaverse Birthplaces of avatars                              | Olympus, Mawrth, Hellas, Amazonis, Arabia, Cydonia, Syrtis Each category represents a virtual city, staged Open City        | Optional                   |
| Race Race      | A virtual character in the metaverse A character has 3 different attributes | Human, Robot, Dog, Ape, Bear Each category represents a character, a character See the description of Hero NFT for details. | Optional                   |
| Rank Class     | Spaceship class Higher class will have more benefits                        | Cargo, Standard, Economy, Business, Premium, First                                                                          | Print boarding pass to get |
...
| ------------------------- | ------------------------------------------------------------------------------------ | ------------------ | -------------------- |
| Power Power               | Play a role in the game, such as: Affects exploration missions and reward settlement | Min: 5 Max: 100    | Ape + 15 Human + 5   |
| Intelligence Intelligence | Play a role in the game, such as: Affects tech levels and reward settlement          | Min: 5 Max: 100    | Robot + 15 Human + 5 |
| Stamina Durable           | Play a role in the game, such as: Affects PvP and reward settlement                  | Min: 5 Max: 100    | Bear + 15 People + 5 |
...
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | -------------------------------------------------------------------------------------- |
| Area           | On a flat map, a land can be made up of at least 1 (1X1) square More squares will make up a larger area                                                | Min: 1x1 Max: 10x10   | Pledge boarding The longer the card time the larger the land area that can be selected |
| Resources      | Contains gold, silver, copper, iron, wood, water, and even magma Tool making and farm construction through resource combinations                       | Min: 1 Max: 100000000 | Character attributes will affect the amount of resources acquired                      |
| Technology     | The number of detectors in the Land determines the technology level The higher the technology level, the more tools and building types can be unlocked | Min: 1 Max: 10        | The initial value is 1                                                                 |
